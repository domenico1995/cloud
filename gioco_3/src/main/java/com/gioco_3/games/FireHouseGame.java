...
import com.gioco_3.GameDescription;
import com.gioco_3.parser.ParserOutput;
import com.gioco_3.type.Command;
import com.gioco_3.type.CommandType;
...
public class FireHouseGame extends GameDescription {
    ...
    public void nextMove(ParserOutput p, PrintStream out) {
        if (p.getCommand() == null) {
            out.println("Scrivi meglio o morirai!");
        } else {
            //move
                ...
                switch (p.getCommand().getType()) {
                    ...
                    case LOOK_AT:
                        if (getCurrentRoom().getLook() != null) {
                            ...
                            out.println("Qui ci sono solo fiamme.");
                        }
                        break;
                    case WHERE:
            ...
            if (noroom) {
                out.println("Da quella parte non si può andare, non sei superman!");
            } else if (move) {
                out.println(getCurrentRoom().getName());
